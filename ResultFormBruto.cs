...
{
    public partial class ResultFormBruto : Form
    {
        ...
        public ResultFormBruto(string voornaam, string achternaam, string bedrijf, double[] verdient, string[] gewerkturen, double[] toeslagbedrag, string[] toeslagnaam, double[] toeslagpercentage)
        {
            InitializeComponent();
        ...
        private void ResultFormBruto_Load(object sender, EventArgs e)
        {
